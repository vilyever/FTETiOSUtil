...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [VDRouter registerViewController:[TestViewController class] url:[TestRouter urlForRouter] ];
    
    
    [VDRouter route:[TestRouter urlForRouter] params:[TestRouter paramsWithTitle:@"router"] ];
