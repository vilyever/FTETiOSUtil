...
@interface VDRouterBaseAppDelegate ()

@end


@implementation VDRouterBaseAppDelegate
...
- (VDRouterRootNavigationViewController *)rootNavigationViewController {
    if (!_rootNavigationViewController) {
        _rootNavigationViewController = [[VDRouterRootNavigationViewController alloc] init];
    }
