//
//  UISearchBar+VDAlwaysReveal.m
//  VDTextInput
//
//  Created by FTET on 14/12/29.
//  Copyright (c) 2014年 Vilyever. All rights reserved.
//

#import "UISearchBar+VDAlwaysReveal.h"
...
@implementation UISearchBar (VDAlwaysReveal)
...
//        [VDNotification(self, UITextFieldTextDidBeginEditingNotification, self) nextAction:^(NSNotification *notification) {
//            if ( [self keyboardSize] )
//            {
//                [self panViewForEditing:YES];
//            }
//        } ];
//
//        [VDNotification(self, UITextFieldTextDidEndEditingNotification, self) nextAction:^(NSNotification *notification) {
//            [self panViewForEditing:NO];
//        } ];
//        
//        [VDNotification(self, UIKeyboardWillShowNotification, nil) nextAction:^(NSNotification *notification) {
//            [self setOriginPanViewCenter:[NSValue valueWithCGPoint:self.panView.center] ];
//            [self setOriginSelfCenterInWindow:[NSValue valueWithCGPoint:[self.superview convertPoint:self.center toView:nil] ] ];
//            [self keyboardWillShow:notification];
//        } ];
//        
//        [VDNotification(self, UIKeyboardDidHideNotification, nil) nextAction:^(NSNotification *notification) {
//            [self setOriginPanViewCenter:nil];
//            [self setOriginSelfCenterInWindow:nil];
//        } ];
//        
//        [VDNotification(self, UIKeyboardWillChangeFrameNotification, nil) nextAction:^(NSNotification *notification) {
//            [self keyboardSizeWillChange:notification];
//        } ];
//        
//        [VDNotification(self, UIApplicationWillChangeStatusBarOrientationNotification, nil) nextAction:^(NSNotification *notification) {
//            [self resignFirstResponder];
//        } ];
        
        if ( [self.vd_alwaysRevealPanView isMemberOfClass:[UIScrollView class] ] )
        {
            ...
            //        [VDObserve(panScrollView, contentOffset) nextActionWithTag:@"AlwaysReveal" action:^(NSDictionary *change) {
            //            CGPoint oldContentOffset = [[change objectForKey:NSKeyValueChangeOldKey] CGPointValue];
            //            CGPoint newContentOffset = [[change objectForKey:NSKeyValueChangeNewKey] CGPointValue];
            //
            //            CGPoint lastOriginSelfCenterInWindow = [ [self originSelfCenterInWindow] CGPointValue];
